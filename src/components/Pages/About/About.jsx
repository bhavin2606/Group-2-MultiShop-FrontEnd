      ...
      <div className="container-fluid">
        ...
        <div className="container mt-5">
          <div className="row mt-4">
            <h4>Introduction</h4>
            <p>
              Multishop is a one stop shop for all your fashion and lifestyle
              needs. Being India's largest e-commerce store for fashion and
              lifestyle products, Multishop aims at providing a hassle free and
          ...
          <div className="row mt-4">
            ...
            <p>
              ...
              make Multishop, the preferred shopping destination in the country.
          ...
          <div className="row mt-4">
            ...
            <p>
              ...
              500 leading Indian and international brands. Prominent brands
              include Adidas, Nike, Puma, Catwalk, Inc 5, United Colors of
              Benetton, FCUK, Timberland, Avirate, FabIndia and Biba to name a
              few. You can also shop from some recently introduced labels such
          ...
          <div className="row mt-4">
            ...
            <ul>
              <li>
                Awarded <b> 'Fashion eRetailer of the Year 2013'</b> by
              ...
              <li>
                Awarded{" "}
                <b>
                  'Images Most Admired Retailer of the Year: Non-Store Retail'
                </b>{" "}
                for 2012 by Images Group
              </li>
              <li>
                Awarded <b>'Best E-commerce Partner of the year 2011-12' </b>by
                Puma India
              </li>
            </ul>
          </div>
