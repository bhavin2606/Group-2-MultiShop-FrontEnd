                ...
                <div className="product-item bg-light mb-4">
                  ...
                  <div className="text-center py-4">
                    ...
                    <div className="d-flex align-items-center justify-content-center mb-1">
                      {[...Array(5)].map((_, index) => (
                        <small key={index} className={`fa ${index < product.rating ? 'fa-star' : (index < product.rating + 0.5 ? 'fa-star-half-alt' : 'fa-star')} text-primary mr-1`} />
                      ))}
